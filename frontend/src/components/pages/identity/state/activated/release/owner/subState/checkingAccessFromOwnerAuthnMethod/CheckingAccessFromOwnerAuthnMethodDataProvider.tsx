...
export const useCheckingAccessFromOwnerAuthnMethodDataContext = () => {
    const context = useContext<Context | undefined>(Context);
    if (!context) {
        throw new Error('useCheckingAccessFromOwnerAuthnMethodDataContext must be used within a CheckingAccessFromOwnerAuthnMethodDataProvider');
    }
    return context;
};

export const CheckingAccessFromOwnerAuthnMethodDataProvider = (props: PropsWithChildren) => {
    const {
